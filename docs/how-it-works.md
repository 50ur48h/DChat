...
The short version is in the [README](../README.md). This is the same product
explained properly, for someone who wants the mechanism.
...
<sub>Installing and running it: [setup.md](setup.md) · Technical
design: [architecture.md](architecture.md) · No license yet, so all
rights reserved.</sub>
